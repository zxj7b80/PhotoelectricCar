...
//        -Ol --use_c++_inline
//    List file    =  
//        G:\FREESCALE智能车竞赛\freescale(九)\程序\总决赛比赛程序21.22.23\2014.08.22\bin\Flash\List\i2c.s
//
///////////////////////////////////////////////////////////////////////////////
...
//   32 		PORTD_PCR9 = PORT_PCR_MUX(2);
        MOV      R0,#+512
        LDR.N    R1,??DataTable1_2  ;; 0x4004c024
        STR      R0,[R1, #+0]
//   33 		PORTD_PCR8 = PORT_PCR_MUX(2);
        MOV      R0,#+512
        LDR.N    R1,??DataTable1_3  ;; 0x4004c020
        STR      R0,[R1, #+0]
//   34 		//设置 MULT 和 ICR   
...
//   37 		I2C0_F  = 0x65;   
        MOVS     R0,#+101
        LDR.N    R1,??DataTable1_4  ;; 0x40066001
        STRB     R0,[R1, #+0]
//   38 		//使能I2C0，不发送应答信号
...
//   48 		PORTC_PCR10 = PORT_PCR_MUX(2);
        MOV      R0,#+512
        LDR.N    R1,??DataTable1_6  ;; 0x4004b028
        STR      R0,[R1, #+0]
//   49 		PORTC_PCR11 = PORT_PCR_MUX(2);
        MOV      R0,#+512
        LDR.N    R1,??DataTable1_7  ;; 0x4004b02c
        STR      R0,[R1, #+0]
//   50 		//设置 MULT 和 ICR   
...
//   53 		I2C1_F  = 0x65;   
        MOVS     R0,#+101
        LDR.N    R1,??DataTable1_8  ;; 0x40067001
        STRB     R0,[R1, #+0]
//   54 		//使能I2C1，不发送应答信号
