...
//                    rc\Sources\C\Component_C\pit.c                          /
//    Command line =  "D:\FREESCALE智能车竞赛\freescale(九)\PhotoelectricCar\ /
//                    src\Sources\C\Component_C\pit.c" -D IAR -D TWR_K60N512  /
...
// D:\FREESCALE智能车竞赛\freescale(九)\PhotoelectricCar\src\Sources\C\Component_C\pit.c
//    1 #include"pit.h"
//    2 
//    3 //==========================================================================
...
//   20       PIT_MCR|=PIT_MCR_FRZ_MASK;                  //使能PIT模块时钟
        ...
        LDR.N    R3,??DataTable2_1  ;; 0x40037000
        STR      R2,[R3, #+0]
//   21       PIT_LDVAL(pitno)=timeout;                   //设置周期  1ms中断
